...
import girlImage from '../../assets/kitchen_image.png'
        ...
        <Container>
            <div className={styles.Exception_Service_Main_Section}>
                ...
                <div className={styles.Exception_Service_ContentSection}>
                    ...
                    <p>At Chinese & Grill, we believe that great food isn’t just about the ingredients—it’s about the passion and care that go into every dish. Our culinary team is dedicated to creating an unforgettable dining experience, where each bite tells a story of creativity, flavor, and tradition.</p>
                   ...
                   <Link to = "/menu" target='_top'> <button className='all-btn'>Explore Menu</button></Link>
                </div>
